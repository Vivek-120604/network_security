...
SCHEMA_FILE_PATH = os.path.join("Artifacts", "data_schema", "schema.yaml")
...
DATA_INGESTION_DATABASE_NAME: str = "VIVEK_AI"
...
"""
    ...
    Data Transformation related constant start with DATA_TRANSFROMATION VAR NAME
"""
...
TRAINING_BUCKET_NAME = "amznstoringbucket"
