...
class TrainingPipeline:
    ...
    def start_model_trainer(self,data_transformation_Artifact:DataTransformationArtifact):
        try:
            self.model_trainer_config : ModelTrainerConfig  = ModelTrainerConfig(training_pipeline_config = self.training_config)    
            ...
            logging.info(f"Model tainer artifact: {model_trainer_artifact}")
