...
from networksecurity.constant.training_pipelines import DATA_INGESTION_COLLECTION_NAME
from networksecurity.constant.training_pipelines import DATA_INGESTION_DATABASE_NAME
